...
class WPF_Form {
    ...
    public function public_themplate(array $template, $page_id, array $request = array()) {
        ...
        ?>
        <div class="ls-filtersort-container" style="display: flex; pointer-events: all;">
        <button class="ls-filtersort-btn" onclick="toggleFilter()">
            Filter
        </button>
        ...
        <script>
            ...
            document.querySelector(".ls-filtersort-btn").classList.toggle("opened");
        }
        </script>
        <div id="filter" class="ls_mobile_filter" style="display: none;">
        <form
                ...
                <?php foreach ($layout as $type => $module): ?>
                    <?php if (!empty($sort_cmb[$type])): ?>
                        ...
                        <?php if ($view || empty($template['data']['empty'])): ?>
                            ...
                            <?php 
                            switch($type) {
                                case "pa_gender": echo '<div class="grid-col">'; break;
                                case "pwb-brand":
                                case "pa_type-of-frame":
                                case "pa_frame-size": echo '</div><div class="grid-col">'; break;
                                case "submit": echo '</div>';
                            }
                            ?>

                            <div class="wpf_item wpf_item_<?php echo $type ?> toggle-parent">
                                ...
                                <?php 
                                /*
                                * Lapo edit to display certain guide buttons below certain attributes
                                */
                                switch($type){
                                    case "pa_face-shape":
                                        ?><div class="ls-attr-guide-btn">
                                            <button class="button">Face Shape Guide</button>
                                        </div>
                                        <?php
                                        break;
                                    case "pa_frame-size":
                                       ?><div class="ls-attr-guide-btn">
                                            <button class="button">Help with Measurement</button>
                                        </div>
                                        <?php
                                        break;
                                } ?>
            ...
            <?php else: ?>
                <li class="<?php echo "wpf_{$cat->taxonomy}_{$cat->term_id}"; ?>">
                    ...
                    <?php else: ?>
                        ...
                        <?php
                            /* 
                            * Lapo edit to display description (icons) next to attribute label
                            * this array contains the attributes the description is visible for
                            */
                            $attr_w_icons = array("pa_frame-shape", "pa_face-shape", "pa_frame-color", "pa_type-of-frame"); 
                            if ( in_array($cat->taxonomy, $attr_w_icons) ) { ?><div class="ls-attr-icon"><?php echo $cat->description ?> </div> <?php } 
                            ?>
