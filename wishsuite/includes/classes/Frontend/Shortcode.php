...
class Shortcode {
    ...
    public function button_shortcode( $atts, $content = '' ){
        ...
        // Fetch option data
        $button_text        = wishsuite_get_option( 'button_text','wishsuite_settings_tabs', 'Add to Wishlist' );
        $button_added_text  = wishsuite_get_option( 'added_button_text','wishsuite_settings_tabs', 'Remove from Wishlist' );
        $button_tooltip_text  = wishsuite_get_option( 'tooltip_button_text','wishsuite_settings_tabs', 'Wishlist' );
        ...
        if( $has_product ) {
            $button_class[] = 'wishsuite-btn-exist';
        }
        ...
        $default_atts = array(
            ...
            'button_tooltip'    => $button_tooltip_text,
