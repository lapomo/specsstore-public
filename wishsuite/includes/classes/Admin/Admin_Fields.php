        ...
        $settings_fields = array(
            ...
            'wishsuite_settings_tabs' => array(
                ...
                array(
                    ...
                    'type'        => 'text',
                    'default'     => __( 'Add to Wishlist', 'wishsuite' ),
                    'placeholder' => __( 'Add to Wishlist', 'wishsuite' ),
                ),
                ...
                array(
                    ...
                    'label'       => __( 'Tooltip Text', 'wishsuite' ),
                    'desc'        => __( 'Enter your wishlist tooltip text for the button on shop pages.', 'wishsuite' ),
                    'type'        => 'text',
