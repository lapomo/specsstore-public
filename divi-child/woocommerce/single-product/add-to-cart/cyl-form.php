	...
	<?php else : ?>
							...
							if ( ! empty( $options ) ) {
								if ( taxonomy_exists( $name ) ) {
									...
									foreach ( $terms as $term ) {
										...
										print_attribute_radio( $checked_value, $term->slug, $term->description, $sanitized_name, 'cyl' );
									}
								} else {
		...
		<div class="single_variation_wrap">
			<?php
                ...
                wc_get_template( 'single-product/add-to-cart/cyl-add-to-cart-button.php' );
